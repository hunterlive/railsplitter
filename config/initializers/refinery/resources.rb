...
Refinery::Resources.configure do |config|
  ...
  # Configure Dragonfly
  # config.dragonfly_secret = "8c90f6d8bff03f08f2e046152c5c439c1429d6c3d6a90c2f"
  # config.dragonfly_url_format = "/system/resources/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "C:/Users/COMBO/Desktop/railsplitter/public/system/refinery/resources"
